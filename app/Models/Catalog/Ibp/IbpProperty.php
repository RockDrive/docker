...
class IbpProperty extends Model
{
    use QueryCacheable;

    protected $table = 'ibp_properties';
    ...
    public static function HUMAN_FILTERS()
    {
        return [
            self::HUMAN_READABLE_FILTER_TYPE_LIST,
            self::HUMAN_READABLE_FILTER_TYPE_INPUT,
            self::HUMAN_READABLE_FILTER_TYPE_RANGE,
        ];
    }
    ...
    public static function HUMAN_READABLE_FILTERS_REVERSE()
    {
        return [
            self::HUMAN_READABLE_FILTER_TYPE_INPUT => self::FILTER_TYPE_INPUT,
            self::HUMAN_READABLE_FILTER_TYPE_LIST => self::FILTER_TYPE_LIST,
            self::HUMAN_READABLE_FILTER_TYPE_RANGE => self::FILTER_TYPE_RANGE,
        ];
    }
    ...
    {
        return $this->hasOne(IbpPropertyGroup::class, 'id', 'property_group_id');
    }
}
